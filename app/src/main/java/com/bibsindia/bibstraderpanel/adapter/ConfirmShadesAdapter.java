...
public class ConfirmShadesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ArrayList<ShadeDetail> mListData;
    private Activity mActivity;
    private onClickListener mListener;

    public ConfirmShadesAdapter(Activity mActivity, ArrayList<ShadeDetail> mListData, onClickListener mListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(inflater.inflate(R.layout.item_confirm_shades, parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int position) {
        ...
        itemHolder.txtTotalQty.setText(String.valueOf(mShadeDetail.getTotalQty()));
